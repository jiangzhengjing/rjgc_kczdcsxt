<?php 
    ...
    $sql=mysql_query(" INSERT INTO panduan  (shiti_tiku,shiti_nandu,shiti_tigan,shiti_xuanxiang,shiti_jiexi,panduan_daan) 
                        VALUES ('$_POST[shiti_tiku]','$_POST[shiti_nandu]','$_POST[shiti_tigan]','$_POST[shiti_xuanxiang]','$_POST[shiti_jiexi]','$_POST[panduan_daan]')");
