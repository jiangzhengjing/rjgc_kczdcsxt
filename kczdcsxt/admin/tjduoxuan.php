<?php 
    include("conn.php");
    $duoxuan_daan = implode(',',$_POST[duoxuan_daan]);
    $sql=mysql_query(" INSERT INTO duoxuan (shiti_tiku,shiti_nandu,shiti_tigan,shiti_xuanxiangA,shiti_xuanxiangB,shiti_xuanxiangC,shiti_xuanxiangD,shiti_jiexi,duoxuan_daan) 
                        VALUES ('$_POST[shiti_tiku]','$_POST[shiti_nandu]','$_POST[shiti_tigan]','$_POST[shiti_xuanxiangA]','$_POST[shiti_xuanxiangB]','$_POST[shiti_xuanxiangC]','$_POST[shiti_xuanxiangD]','$_POST[shiti_jiexi]','$duoxuan_daan')");
var_dump($_POST);
