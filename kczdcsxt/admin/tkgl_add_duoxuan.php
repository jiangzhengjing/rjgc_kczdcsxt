                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="form-group duoxuan_daan">
                                           <label for="zqda" class="col-sm-3 form-label">正确答案</label>
                                            <div class="col-sm-9">
                                                <input type="checkbox" name="duoxuan_daan[]" value="A">&nbsp;A&nbsp;&nbsp;
                                                <input type="checkbox" name="duoxuan_daan[]" value="B">&nbsp;B&nbsp;&nbsp;
                                                <input type="checkbox" name="duoxuan_daan[]" value="C">&nbsp;C&nbsp;&nbsp;
                                                <input type="checkbox" name="duoxuan_daan[]" value="D">&nbsp;D&nbsp;&nbsp;
